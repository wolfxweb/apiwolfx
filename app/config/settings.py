...
class Settings:
    ...
    def __init__(self):
        ...
        self.ml_redirect_uri = os.getenv("ML_REDIRECT_URI", "https://43a73f1e9df0.ngrok-free.app/api/callback")
        ...
        self.mp_success_url = os.getenv("MP_SUCCESS_URL", "https://43a73f1e9df0.ngrok-free.app/payment/success")
        self.mp_failure_url = os.getenv("MP_FAILURE_URL", "https://43a73f1e9df0.ngrok-free.app/payment/failure")
        self.mp_pending_url = os.getenv("MP_PENDING_URL", "https://43a73f1e9df0.ngrok-free.app/payment/pending")
        self.mp_webhook_url = os.getenv("MP_WEBHOOK_URL", "https://43a73f1e9df0.ngrok-free.app/api/payments/webhooks/mercadopago")
