...
class WebhookNotification(BaseModel):
    ...
    date_created: str = Field(..., description="Data de criação")
    application_id: Optional[int] = Field(None, description="ID da aplicação")
    user_id: Optional[int] = Field(None, description="ID do usuário")
    version: Optional[int] = Field(None, description="Versão")
